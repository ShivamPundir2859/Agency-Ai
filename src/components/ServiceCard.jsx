...
const ServiceCard = ({ service, index }) => {
    ...
    return (
        <div className='relative overflow-hidden max-w-lg sm:m-4 rounded-xl border
        border-gray-200 dark:border-gray-700 shadow-2xl shadow-gray-100 dark:shadow-gray-900'>
            ...
            transition-opacity duration-500 mix-blend-lighten dark:mix-blend-darken' style={{
