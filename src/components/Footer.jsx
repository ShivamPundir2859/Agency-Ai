    ...
    return (
        ...
        sm:px-10 lg:px-24 xl:px-40'>
            <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
                ...
                dark:text-gray-400'>
                    ...
                    <ul className='flex gap-8'>
                        ...
                        <li><a className='hover:text-primary' href="#teams">Teams</a></li>
                ...
                <motion.div
                    ...
                    <h3 className='font-semibold'>Subscribe to our
                        newsletter
                    </h3>
                    <p className='text-sm mt-2 mb-6'>The lastest news,
                        articles, and resources, sent to your inbox weekly.
                    </p>
                    <div>
                        <input type="email" placeholder='Enter your email'
                            className=' p-3 text-sm outline-none rounded
                        dark:text-gray-200 bg-transparent border
                        border-gray-300 dark:border-gray-500  '/>
                        <button className=' bg-primary text-white rounded px-6 ml-2 h-11'>Subscribe</button>
                    </div>
                </motion.div>
            </div>
            ...
            justify-center sm:justify-between gap-4 flex-wrap'>
                <p>Copyright 2026 Shivam - All Right Reserved</p>
