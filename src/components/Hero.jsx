...
const Hero = () => {
    return (
        <div id='hero' className='flex flex-col items-center gap-6
        py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full
        overflow-hidden text-gray-700 dark:text-white'>
            ...
            pr-4 rounded-full'>
                <img className='flex w-20' src={assets.group_profile} alt="" />
            ...
            xl:leading-[95px] max-w-5xl'>Turning imgination into <span className='bg-gradient-to-r 
            from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent'>digital</span> <br /> impact.</motion.h1>
